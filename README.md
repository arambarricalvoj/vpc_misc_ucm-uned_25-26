...
- ``VpC_TrabajoPracticoTemas8-12_JavierArambarriCalvo.pdf`` es la memoria del trabajo práctico y en el directorio 
``trabajoPractico_temas_8_12`` se encuentra el código.
